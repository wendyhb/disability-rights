...
path_democracy<-"data-raw/renamed/democracy_index_2006-2022_2023-11-8.csv"
democracy_table<- read_csv(path_democracy)
head(democracy_table)
democracy_table
...
write_rds(democracy, "data/clean-raw/democracy.rds")
# decmocracy category reference: https://en.wikipedia.org/wiki/The_Economist_Democracy_Index
